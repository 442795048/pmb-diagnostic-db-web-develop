<template>
  ...
  >
		<LevelTwoForm ref="levelFormRef" :activeIndex="activeIndex" :highlight="highlight" :disabled="disabled" :formData="formData" />
    <template #footer>
...
import LevelTwoForm from "./LevelTwoForm.vue";
...
const handleSave = () => {
	loading.value = true;
  let insertParams = {
    studyLevel2WorkingPackageList: levelFormRef.value.getPanalForm(),
