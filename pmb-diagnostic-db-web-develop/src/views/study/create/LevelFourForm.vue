	...
	<div class="w-full">
		...
		<CollapseComponent title="HGR" :showAdd="false" style="font-size: 12px;color: #4a4a4a;" :panels="panelForms"
			...
			<template #panel-widget="{ item, idx }">
				...
				<!-- 子级折叠面板 -->
				<CollapseComponent :showTitle="false" :showAdd="true" :showDelete="!disabled" :title="`HGR-${idx}`"
					style="font-size: 12px;color: #4a4a4a;" :panels="item.panelForms" :active-panels="activePanelsChild"
